...
export default function Login() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-6 bg-slate-900 relative overflow-hidden">
            ...
            <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-teal-600/20 rounded-full blur-[120px] animate-pulse"></div>
            ...
            <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
                ...
                <div className="hidden lg:block space-y-8">
                    ...
                    <h2 className="text-6xl font-black text-white leading-[1.1] tracking-tight">
                        The future of <br/>
                        <span className="bg-clip-text text-transparent bg-gradient-to-r from-teal-400 to-indigo-400">Clinical Intelligence.</span>
                    </h2>
                    ...
                    <div className="grid grid-cols-2 gap-6 pt-8">
                        {[
                            { icon: <ShieldCheck className="text-teal-500" />, label: 'Secure AI' },
                ...
                <div className="flex justify-center lg:justify-end">
                    <div className="w-full max-w-md space-y-8 bg-white/5 backdrop-blur-2xl p-10 rounded-[3rem] border border-white/10 shadow-2xl relative group">
                        ...
                        <div className="text-center lg:hidden flex flex-col items-center mb-8">
                            <Activity className="text-teal-500 mb-4" size={48} />
                        ...
                        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                            ...
                            <div className="space-y-4">
                                <div className="group/input relative">
                                    <Mail className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500 group-focus-within/input:text-teal-500 transition-colors" size={20} />
                                    <input
                                        type="email"
                                        required
                                        value={email}
                                        onChange={(e) => setEmail(e.target.value)}
                                        className="w-full bg-white/5 border border-white/10 rounded-2xl px-12 py-4 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-teal-500/50 focus:border-teal-500 transition-all font-medium"
                                        placeholder="Enter your email"
                                    />
                                </div>
                                <div className="group/input relative">
                                    <Lock className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500 group-focus-within/input:text-teal-500 transition-colors" size={20} />
                                    <input
                                        type="password"
                                        required
                                        value={password}
                            ...
                            <button
                                type="submit"
                                disabled={isLoading}
                                className="w-full py-4 bg-gradient-to-r from-teal-600 to-indigo-600 text-white rounded-2xl font-black text-sm uppercase tracking-widest hover:opacity-90 transition-all shadow-xl shadow-teal-500/20 flex items-center justify-center gap-2 group/btn disabled:opacity-50"
                            >
                        ...
                        <div className="text-center pt-4">
                            <p className="text-gray-500 text-sm font-medium">
                                ...
                                <Link to="/register" className="text-teal-500 font-bold hover:underline">
                                    Create one now
                                </Link>
                            </p>
                        </div>
